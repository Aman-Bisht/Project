...
// app.use(express.static(static_path)); //esme css hai aur static html and javascript bhi rakhte hai
app.set("views", templates_path); // yeah bata rahi hai uska particular address
app.set("view engine", "hbs"); //this line is also imp kuki yeah file bata rahi hai
hbs.registerPartials(
  partials_path
); /*yeah partial ko define kar raha hai node.js ke ander yeah tab use
 hota hai jab koi cheej bar bar new page mai use ho rahi ho like navbar ({{>navbar}}) jo brav=ces ke ander hai usme file ka naam ata hai*/

app.get("/", (req, res) => {
  res.render("front"); // yaha par index likha hua tha and maine resume kar diya hai jisse ab seddhe resume page open higa
});
